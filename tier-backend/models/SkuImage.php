 ...
 * @property Sku $sku
 */
class SkuImage extends \drodata\db\ActiveRecord
{
    ...
    {
        return [
            [['sku_id', 'attachment_id'], 'required'],
            [['sku_id', 'attachment_id'], 'integer'],
            [['sku_id', 'attachment_id'], 'unique', 'targetAttribute' => ['sku_id', 'attachment_id']],
    ...
    */
    ...
    public function getActionOptions($action)
    {
        ...
        $hint = null;
        $confirm = null;
        $route = ["/sku-image/$action", 'sku_id' => $this->sku_id, 'attachment_id' => $this->attachment_id];
