 ...
 */
class Property extends \drodata\db\ActiveRecord
{
    // const STATUS_ = 1;
    // const SCENARIO_ = '';
    // 单独上传附件事件
    ...
    */
    ...
    {
        return [
            [['spu_id', 'taxonomy_id'], 'required'],
            [['spu_id', 'taxonomy_id'], 'integer'],
    ...
    */
    ...
    {
        return $this->hasMany(Specification::className(), ['property_id' => 'id']);
    }
